 ...
 */
package dhbwka.wwi.vertsys.javaee.Malteser.common.web;
...
public class SignUpServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Eingaben prüfen
        User user = new User(vorname, nachname, username, password1);
        ...
        if (errors.isEmpty()) {
            try {
                this.userBean.signup(vorname, nachname, username, password1);
