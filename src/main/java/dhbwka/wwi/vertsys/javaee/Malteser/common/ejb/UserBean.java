 ...
 */
package dhbwka.wwi.vertsys.javaee.Malteser.common.ejb;
...
public class UserBean {
     ...
     */
    public void signup(String vorname, String nachname, String username, String password) throws UserAlreadyExistsException {
        if (em.find(User.class, username) != null) {
            throw new UserAlreadyExistsException("Der Benutzername $B ist bereits vergeben.".replace("$B", username));
        }

        User user = new User(vorname, nachname, username, password);
